...
// these variables will be used to pick a random color in setup()
...
function setup() {
  ...
  // assign each color component a random value between 128-255
...
function mouseDragged() {
  ...
  let data = {
    x: mouseX,
    y: mouseY,
    // include the randomly selected color
    colorR: colorR,
    colorG: colorG,
    colorB: colorB,
  };
